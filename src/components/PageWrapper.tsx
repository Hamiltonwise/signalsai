      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 h-16 bg-white border-b border-slate-200 flex items-center justify-between px-4 sm:px-6 z-[60] shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 bg-alloro-cobalt rounded-lg flex items-center justify-center text-white font-bold text-sm">
              {onboardingCompleted
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="p-2 text-slate-400 hover:text-alloro-cobalt transition-colors relative"
          >
            <Bell size={20} />
