      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="bg-gray-50 rounded-2xl shadow-2xl max-w-7xl w-full max-h-[90vh] overflow-y-auto"
                  ...
                  <div className="space-y-4">
                    ...
                    >
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        Select the PMS system type or use auto-detect to let the
                        system determine it automatically.
                      </p>
                    </motion.div>
