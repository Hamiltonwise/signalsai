                  ...
                  <div className="pl-15 ml-6 border-l-2 border-slate-100 pl-6 space-y-3">
                    <div className="flex items-start gap-3">
                      ...
                      <p className="text-slate-600 text-sm">
                        <strong>What we access:</strong> Website traffic data,
                        user sessions, page views, conversion events, and
                        engagement metrics.
                      </p>
                    </div>
                    <div className="flex items-start gap-3">
                      ...
                      />
                      <p className="text-slate-600 text-sm">
                        <strong>How we use it:</strong> Generate insights about
                        your practice's online presence, track marketing
                ...
                <div className="space-y-4">
                  ...
                  <div className="pl-15 ml-6 border-l-2 border-slate-100 pl-6 space-y-3">
                    <div className="flex items-start gap-3">
                      ...
                      />
                      <p className="text-slate-600 text-sm">
                        <strong>What we access:</strong> Search performance data
                        including impressions, clicks, average position, and
                        keyword rankings.
                      </p>
                    </div>
                    <div className="flex items-start gap-3">
                      ...
                      />
                      <p className="text-slate-600 text-sm">
                        <strong>How we use it:</strong> Monitor your SEO
                        performance, track keyword rankings, and provide
