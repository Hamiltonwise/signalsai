...
import { Bug, CheckCircle, AlertTriangle, RefreshCw, Wifi, WifiOff } from 'lucide-react';
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-xl shadow-2xl max-w-4xl w-full mx-4 max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 space-y-6">
          {/* Quick Issues */}
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-3">Quick Diagnostic</h3>
                ...
                <div className="grid grid-cols-3 gap-4 p-4 bg-gray-50 rounded-lg">
                  ...
                  <div className="text-center">
                    <div className="text-2xl font-bold text-blue-600">
                      {((testResults.passed / testResults.total) * 100).toFixed(0)}%
                    </div>
          ...
          {/* Manual Tests */}
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-3">Manual Tests</h3>
            <div className="grid grid-cols-2 gap-3">
              <button
                onClick={() => window.open('https://hamiltonwisedashboard.netlify.app/', '_blank')}
